...
export default function ContactForm() {
  ...
  return (
    <>
            ...
            >
              ...
              <div className="row lg:w-1/2">
                ...
                <div className="col">
                  <button
                    type="submit"
                    className="uppercase text-white inline-flex items-center justify-center bg-brand-green font-semibold  tracking-wider  py-4 px-10 rounded-full"
                  >
                    Send
                  </button>
                </div>
      ...
      <div className="bg-brand-gray-bg py-12"></div>
    </>
  )
}
